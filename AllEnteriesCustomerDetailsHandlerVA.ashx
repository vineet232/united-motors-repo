<%@ WebHandler Language="C#" Class="AllEnteriesCustomerDetailsHandlerVA" %>
...
public class AllEnteriesCustomerDetailsHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForCustomersAllEnteriesVA", con);
