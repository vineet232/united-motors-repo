<%@ WebHandler Language="C#" Class="AllEnteriesFitnessHandler" %>
...
public class AllEnteriesFitnessHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForFitnessAllEnteries", con);
