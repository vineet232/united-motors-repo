...
function BindDataTable() {
    ...
    { "visible": false, "targets": [1] }
        ...
        bServerSide: true,
        sAjaxSource: 'AllEnteriesPurchasesHandlerVA.ashx/GetPurchasesList',
        sServerMethod: 'post',
        "processing": true,
        ...
        //                {"data": "employeename"},
                   ...
                   { "data": "purchasetransactiontypeid",
                       render: function (data, type, row) {
                           return row.purchasetransactiontypeid + '<br /> -------- <br />(' + row.purchasedt + ')';
                       }
                   },

                    { "data": "accounttype",
                        render: function (data, type, row) {
                            return row.accounttype + '<br /> -------- <br />' + row.vendorname + '';
                        }
                    },
                    { "data": "invoicetype",
                        render: function (data, type, row) {
...
//                            }
                            ...
                            return "<div class='text-nowrap'>" + '<b style="color:green;"> Type- </b>' + row.invoicetype + '<br /> <b style="color:green;"> Inv#- </b> ' + row.invoiceslipno + '<br /> <b style="color:green;">Mode-</b> ' + row.paymentmode + '<br /> <b style="color:green;">Amount-</b> ' + row.amount + '' + "</div>";
                        }
                    },
                     ...
                     { "data": "oldpurchasedt",
                         render: function (data, type, row) {
                             return "<div class='text-nowrap'>" + '<b style="color:red;"> Dt.- </b>' + row.oldpurchasedt + '<br /> <b style="color:red;"> Mode- </b> ' + row.oldvendorname + '' + "</div>";
                         }
                     },
                    { "data": "oldinvoicetype",
                        render: function (data, type, row) {
                            return "<div class='text-nowrap'>" + '<b style="color:red;"> Type- </b>' + row.oldinvoicetype + '<br /> <b style="color:red;"> Inv#- </b> ' + row.oldinvoiceslipno + '<br /> <b style="color:red;">Mode-</b> ' + row.oldpaymentmode + '<br /> <b style="color:red;">Amount-</b> ' + row.oldamount + '<br /> <b style="color:blue;">Last Trns.-</b> ' + row.remarks + '' + "</div>";
                        }
                    },
                    { "data": "createdon",
                        render: function (data, type, row) {
