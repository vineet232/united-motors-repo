...
$(document).ready(function () {
    ...
    $.ajax({
        type: "POST", url: "salesTransactionDetailsCustomerVA.aspx/GetAllCustomersList",
        dataType: "json",
...
//     GetCustomersByAccountTypeID(accounttypeID);
 ...
 function GetInvoiceNo(accounttypeid) {
  var invNo=0;
     ...
     $.ajax({
         type: "POST",
         url: "salesTransactionDetailsCustomerVA.aspx/GetInvoiceNoByAccountTypeID",
            ...
            /// var invNo = accounttype.substring(0, 4).toUpperCase() +"-" + JSON.stringify(res.d)
             ...
             if(accounttypeid=="1")
             {
                   ...
                   //// myNumber+=JSON.stringify(res.d);
                    invNo= parseInt(3060)  +  parseInt( JSON.stringify(res.d));

                      $.ajax({
                     type: "POST",
                     url: "salesTransactionDetailsCustomerva.aspx/GetSlipDetailofPendingSlips",
                     ////data: '{ accountTypeID :' + accounttypeid + '}',
                     dataType: "json",
                     contentType: "application/json",
                     ...
                     var json2 = JSON.parse(res2.d);
                         $("#txtInvoiceNo").val("VA/" + json2[0].slipno);
...
//// $("#ddlCustomers").empty();
 ...
 $('#ddlCustomers').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "salesTransactionDetailsCustomerVA.aspx/GetAllVendorsList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlCustomers').find('option:not(:first)').remove();
 ...
 $("#Showoverlay").show();
    $.ajax({
        type: "POST", url: "salesTransactionDetailsCustomerVA.aspx/GetAllEmployeesList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlCustomers').find('option:not(:first)').remove();
...
//// $("#ddlCustomers").empty();
 ...
 $('#ddlCustomers').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "salesTransactionDetailsCustomerVA.aspx/GetAllGeneralLedgersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlCustomers').find('option:not(:first)').remove();
...
function BindDataTable() {
 ...
 var searchDt = $("#txtInvoiceDate").val();
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'SaleTransactionDetailsCustomersHandlerVA.ashx/GetSaleTransactionDetailsCustomersData?searchdt=' + searchDt,
                sServerMethod: 'post',
                "processing": true,
                "columns": [
                 { "data": "id" ,
...
function AddRecord() {
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "salesTransactionDetailsCustomerVA.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "salesTransactionDetailsCustomerVA.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function UpdateRecord() {
    ...
    model.vehchasisno = vehchasisno;
        ...
        $.ajax({
            type: "POST",
            url: "salesTransactionDetailsCustomerVA.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
////        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "salesTransactionDetailsCustomerVA.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
