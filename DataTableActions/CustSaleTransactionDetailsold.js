...
function BindDataTable() {
 ...
 $("#tblRecords").dataTable().fnDestroy();
  ...
  var searchparameters = ""
    ...
    if ($('#rdsearchbyinvno').prop('checked')) {
        searchparameters = "invoiceno";
    } 
    if ($('#rdsearchbyamount').prop('checked')) {
        searchparameters = "amount";
    } 
    if ($('#rdsearchbyvehchasisno').prop('checked')) {
        searchparameters = "vehchasisno";
    } 
