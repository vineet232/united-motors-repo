...
////                $("#ddlAccountType").append($("<option></option>").val(value.id).html(value.renewalFrom));
////            })
////        }
////        ,
...
//    $.ajax({
//        type: "POST",
//        url: "mastercustomers.aspx/GetAllData",
//        data: '',
...
////                bServerSide: true,
////                sAjaxSource: 'MasterCustomersHandler.ashx/GetCustomersList',
////                sServerMethod: 'post',
////                "processing": true,
////               
////                 
                    ...
                    { "data": "reportstatus",
                        render: function (data, type, row) {
                           //debugger
                            ...
                            if(row.statusupdatedon!=null)
                            {
                                statusdate =  moment(row.statusupdatedon).format('DD-MMM-YYYY hh:mm A');
                            }
...
function updatereportstatus(id)
 {
     ...
     $("#Showoverlay").show();
        $.ajax({
            type: "POST",
            url: "mastercustomers.aspx/UpdateReportStatus",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
//    }
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "mastercustomers.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "mastercustomers.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//                }
                ...
                //////$('[id*=divWhatsappMessage]').style.display='inline';
...
////    }
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "mastercustomers.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//////        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "mastercustomers.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function validate() {
    ...
    if ($('#ddlAccountType :selected').val() == "0") {
...
function SendWhatsppMessage()
{
   ...
   var id = $('[id*=recordID]').val();
    ...
    model.contactno=contactno;
     ...
     $.ajax({
        type: "POST",
        url: "mastercustomers.aspx/SaveandSendWhatsappMessage",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
