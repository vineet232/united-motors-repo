...
$("#ddlDesignation").select2();
    ...
    $.ajax({
     ...
     $.ajax({
        type: "POST", url: "masteremployees.aspx/GetDressNameQtyAboveZero",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
            $.each(res.d, function (data, value) {
...
//    }
    ...
    $.ajax({
            type: "POST",
            url: "masteremployees.aspx/UpdateDressRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function BindDressDataTable(id)
{
   ...
   // debugger;
      $.ajax({
        type: "POST",
        url: "masteremployees.aspx/GetAllDressDetailsByEmpID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
//        table.row($(this).parents('tr')).remove().draw();
    ...
    ////alert(JSON.stringify(model));
        ...
        $.ajax({
            type: "POST",
            url: "masteremployees.aspx/DeleteDressRecord",
              data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
/////alert(JSON.stringify(model));
    ...
    $.ajax({
            type: "POST",
            url: "masteremployees.aspx/UpdateSalaryRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function BindSalaryDataTable(id)
{
   ...
   // debugger;
      $.ajax({
        type: "POST",
        url: "masteremployees.aspx/GetAllSalaryDetailsByEmpID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
//        table.row($(this).parents('tr')).remove().draw();
    ...
    ////alert(JSON.stringify(model));
        ...
        $.ajax({
            type: "POST",
            url: "masteremployees.aspx/DeleteSalaryRecord",
              data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
