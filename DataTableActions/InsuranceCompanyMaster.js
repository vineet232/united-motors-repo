...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancecompany.aspx/GetAllData",
        data: '',
        ...
        success: function (data) {
            ...
            $.each(json, function (key, item) {
                srno += 1;
                var id = item.id;
                var modelname = item.inscompname;
                rows += "<tr><td>" + id + "</td>" +
                 "<td>" + srno + "</td>" +
                    "<td>" + modelname + ' ' +
                    "</td>" +
...
function AddRecord() {
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancecompany.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancecompany.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            ...
            if (result.d == "10") {
                ...
                ////debugger;
                var modelname = json[0].inscompname;
                //alert(modelname);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterinsurancecompany.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterinsurancecompany.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
