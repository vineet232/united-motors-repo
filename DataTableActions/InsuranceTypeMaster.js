...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancetype.aspx/GetAllData",
        data: '',
        ...
        success: function (data) {
            ...
            $.each(json, function (key, item) {
                var id = item.id;
                var modelname = item.insurancetype;
                rows += "<tr><td>" + id +
                    "</td><td>" + modelname + ' ' +
                    "</td>" +
                    "<td> " +
...
function AddRecord() {
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancetype.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterinsurancetype.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            ...
            if (result.d == "10") {
                ...
                var modelname = json[0].insurancetype;
                //alert(modelname);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterinsurancetype.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterinsurancetype.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
