...
function BindDataTable() {
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'paymenttransactionsHandler.ashx/GetPaymentTransactionData?searchdt=' + searchDt + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,
                sServerMethod: 'post',
                "processing": true,
                "columns": [
                 { "data": "id" ,
...
////                    { "data": "accounttype" },
                    ...
                    render: function ( data, type, row )
                        ...
                        {
                            return  "<div class='text-nowrap'> <span ><i class='fa fa-rupee '></i></span> &nbsp;" + row.amount + " <i style='font-size:large; transform: rotate(50deg);' class='fa fa-arrow-down text-success'></i> </div>";
                        }
                     }
                    },
//                     { "data": "discount" },
