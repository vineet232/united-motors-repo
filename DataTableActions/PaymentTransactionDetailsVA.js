...
$(document).ready(function () {
   $.ajax({
        type: "POST", url: "paymenttransactionsva.aspx/GetAllPaymentMethodswithBank",
        dataType: "json",
...
//    $.ajax({
//        type: "POST",
//        url: "paymenttransactionsVA.aspx/GetInvoiceNoByAccountTypeID",
...
//}
 ...
 function ddlPaymentMode_SelectedIndexChanged()
 {
    ...
    ////if(custpaymentmodeid == 3 || custpaymentmodeid == 4 || custpaymentmodeid == 5 || custpaymentmodeid == 6 || custpaymentmodeid == 7 || row.paymentmodeid == "9")
 ...
 $("#Showoverlay").show();
    $.ajax({
        type: "POST", url: "paymenttransactionsva.aspx/GetAllBanksList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
...
//// $("#ddlPaymentTo").empty();
 ...
 $('#ddlPaymentTo').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "paymenttransactionsVA.aspx/GetAllVendorsList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlPaymentTo').find('option:not(:first)').remove();
 ...
 $("#Showoverlay").show();
    $.ajax({
        type: "POST", url: "paymenttransactionsVA.aspx/GetAllEmployeesList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlPaymentTo').find('option:not(:first)').remove();
 ...
 $("#Showoverlay").show();
    ...
    $.ajax({
        type: "POST", url: "paymenttransactionsVA.aspx/GetAllCustomersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlPaymentTo').find('option:not(:first)').remove();
...
//// $("#ddlPaymentTo").empty();
 ...
 $('#ddlPaymentTo').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "paymenttransactionsVA.aspx/GetAllGeneralLedgersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlPaymentTo').find('option:not(:first)').remove();
...
//////// for search///////
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
            //// sAjaxSource: 'paymenttransactionsHandlerVA.ashx/GetPaymentTransactionData',

            //////// for search///////
            sAjaxSource: 'paymenttransactionsHandlerVA.ashx/GetPaymentTransactionData?searchdt=' + searchDt + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,
            //////// end for search///////
...
////                    { "data": "accounttype" },
                   ...
                   { "data": "paymentmode",
                    ...
                    render: function ( data, type, row )
                     {
                        ///return row.paymentreceiptid;
                        if(row.paymentreceiptid=="1")
                        {
                            return  "<div class='text-nowrap'>  <span ><i class='fa fa-rupee '></i></span> &nbsp;" + row.amount + " <i style='font-size:large; transform: rotate(0.15turn);' class='fa fa-arrow-up text-danger'></i> </div>";
                        }
                        if(row.paymentreceiptid=="2")
                        {
                            return  "<div class='text-nowrap'>  <span ><i class='fa fa-rupee '></i></span> &nbsp;" + row.amount + " <i style='font-size:large; transform: rotate(0.15turn);' class='fa fa-arrow-down text-success'></i> </div>";
                        }
                     }
...
var paymenttobankid = $("#ddlPaymentToBank2 :selected").val();
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "paymenttransactionsVA.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "paymenttransactionsVA.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
    ...
    model.oldpaymenttobank = oldpaymenttobank;
     ...
     model.pmodebankid = pmodebankid;
      ...
      model.oldpmodebankname = oldpmodebankname;
        ...
        $.ajax({
            type: "POST",
            url: "paymenttransactionsVA.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
const myArray = empdata.split(",");
    ...
    model.accounttypeid=accounttypeid;
        ...
        $.ajax({
            type: "POST",
            url: "paymenttransactionsVA.aspx/DeleteRecord",
           //// data: '{ id :' + id + '}',
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
