...
$(document).ready(function () {
    ...
    $.ajax({
        type: "POST", 
        url: "masterproductline.aspx/GetAllEmissionTypeList",
        dataType: "json",
...
function BindLineofBusiness() {
    ...
    $.ajax({
        type: "POST",
        url: "masterproductline.aspx/GetLineofBusinessByParentIDList",
...
function BindParentProductLine() {
    ...
    $.ajax({
        type: "POST",
        url: "masterproductline.aspx/GetParentProductLineByParentIDList",
...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterproductline.aspx/GetAllData",
        //// data: '',
        data: '{ model :' + JSON.stringify(model) + '}',
...
function AddRecord() {
    ...
    var productline = $('[id*=txtname]').val();
    var lineofbusinessid = $("#ddllineofbusiness :selected").val();
    var emissiontypeid = $("#ddlemissiontype :selected").val();
    var parentproductlineid = $("#ddlparentproductline :selected").val();
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "masterproductline.aspx/SaveRecord",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterproductline.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//                var modelname = json[0].modelname;
                ...
                $('#txtname').val(json[0].productline);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterproductline.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterproductline.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
