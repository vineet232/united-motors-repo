...
//    $.ajax({
//        type: "POST", url: "purchasetransactionsVA.aspx/GetAllPaymentMethods",
//        dataType: "json",
...
$('#ddlPaymentTo').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "purchasetransactionsVA.aspx/GetAllVendorsList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlPaymentTo').find('option:not(:first)').remove();
...
//    $.ajax({
//        type: "POST",
//        url: "purchasetransactionsVA.aspx/GetInvoiceNoByAccountTypeID",
...
//// $("#ddlPaymentTo").empty();
 ...
 $("#Showoverlay").show();
    ...
    $.ajax({
        type: "POST", url: "purchasetransactionsva.aspx/GetAllCustomersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlPaymentTo').find('option:not(:first)').remove();
...
function BindDataTable() {
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'purchaseTransactionsHandlerVA.ashx/GetPurchaseTransactionData?searchdt=' + searchDt + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,
                sServerMethod: 'post',
                "processing": true,
                "columns": [
                 { "data": "id" ,
...
////                    { "data": "accounttype" },
...

                    {
                       ...
                       "render": function (data, type, row ) {
                           ...
                           {
                           return  '<a href="#" onclick="OpenPartsDetails(' + row.id + ')"><i class="glyphicon glyphicon-plus text-danger" style="font-size:x-large;"></i></a>';
                           }
                           else
                           {
                             return '<a href="#" onclick="OpenPartsDetails(' + row.id + ')"><i class="glyphicon glyphicon-plus text-primary" style="font-size:x-large;"></i></a>';
                           }
                       }
...
////                       {
////                         
////                                ///////return '<a href="#" onclick="OpenPartsDetails(\'' + row.id + ',' + row.customername + ',' + row.vehicleno + ',' + row.statusid + '\'\)">  <i class="glyphicon glyphicon-plus text-primary" style="font-size:x-large;"></i> </a>';
////                          
////                             return '<a href="#" onclick="OpenPartsDetails(' + id + ')"><i class="glyphicon glyphicon-plus text-primary" style="font-size:x-large;"></i></a>'
////                       }
...
function AddRecord() {
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "purchasetransactionsVA.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "purchasetransactionsVA.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function UpdateRecord() {
   ...
   var purchasetypename = $("#ddlPurchaseType :selected").text();
    ...
    model.oldamount = oldamount;
        ...
        $.ajax({
            type: "POST",
            url: "purchasetransactionsVA.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//    model.accounttypeid=accounttypeid;
        ...
        $.ajax({
            type: "POST",
            url: "purchasetransactionsVA.aspx/DeleteRecord",
           data: '{ id :' + id + '}',
...
function validate() {
 ...
 function  btnUploadFile()
            ...
            if (size <= 5000) {
                $.ajax({
                   ////// url: 'InsuranceClaimsPolicyUploadHandler.ashx?claimid=' + id+'&mobileno=' + omobileno,
                    url: 'PurchaseTransactionsBillUploadHandlerVA.ashx?pid=' + id ,
                    type: 'POST',
     ...
     var id=$("#hdnviewfileid").val();
        $.ajax({
            type: "POST",
        url: "purchasetransactionsVA.aspx/ConvertToPdfAndDownload",
        data: '{id: "' + id + '" }',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (r) {
    ...
    function ChangeApprovalStatus(id)
{
     $("#Showoverlay").show();
        $.ajax({
            type: "POST",
            url: "purchasetransactionsva.aspx/UpdateReportStatus",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
//         $('#txtDCustomerName').html(customername);
  ...
  ////$('#btnUpdateDetails').hide();
    ...
    $.ajax({
        type: "POST",
        url: "purchasetransactionsVA.aspx/GetAllPartsByID",
       data: '{purchaseid : ' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
 ...
 function GetPartDetailsbyPartNo()
 {
   ...
   ///// alert(partNo);
    ...
    $("#Showoverlay").show();
     $.ajax({
         type: "POST",
         url: "purchasetransactionsVA.aspx/GetPartDescByPartNo",
       ////  data: '{ partno :' + partNo + '}',
       data: '{ model :' + JSON.stringify(model) + '}',
         dataType: "json",
         contentType: "application/json",
   ...
   function AddRecordDetails() {
    ...
    $('#hdnOldQty').val("0") 
     ...
     if ($('#ddlTruckCompanies :selected').val().trim() == "0") {
        $('#ddlTruckCompanies').css('border-color', 'Red');
        isValid = false;
    }
    else {
        $('#ddlTruckCompanies').css('border-color', 'green');
    }
...
//    }
   ...
   /////alert(purchaseid);
    ...
    var truckcompid = $("#ddlTruckCompanies :selected").val();
    var truckcompname = $("#ddlTruckCompanies :selected").text();
...
//    }
   ...
   ///// var challanno= $('#txtDSlipNo').html();
    ...
    model.remarks=remarks;
     ...
     model.truckcompid = truckcompid;
    model.truckcompname = truckcompname;
    

    $.ajax({
        type: "POST",
        url: "purchasetransactionsVA.aspx/SaveRecordDetails",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function EditRecordbyIDDetails(id) {
    ...
    $.ajax({
        type: "POST",
        url: "purchasetransactionsVA.aspx/GetRecordbyIDDetails",
...
////    }
  ...
  //  model.challanno = challanno;
    ...
    /////alert(paymentmode + modelname + status);
        ...
        $.ajax({
            type: "POST",
            url: "purchasetransactionsVA.aspx/UpdateRecordDetails",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//////        table.row($(this).parents('tr')).remove().draw();
 ...
 ////var challanno =  $('#txtDSlipNo').val();
        ...
        $.ajax({
            type: "POST",
            url: "purchasetransactionsVA.aspx/DeleteRecordDetails",
            //////data: '{ id :' + id + '}',
             data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
