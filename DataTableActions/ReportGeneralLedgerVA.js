...
$(document).ready(function () {
    ...
    $.ajax({
        type: "POST", url: "reportgeneralledgerVA.aspx/GetAllGeneralLedgersList",
        dataType: "json",
...
$("#Showoverlay").show();
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'reportGeneralLedgerHandlerVA.ashx?ledgerID=' + ledgerID +'&startDt='+ startDT +'&endDt='+ endDt,
                sServerMethod: 'post',
                "processing": true,
                "columns": [
