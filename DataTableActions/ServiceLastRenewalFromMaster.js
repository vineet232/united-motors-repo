...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "servicelastrenewalfrom.aspx/GetAllData",
        data: '',
        ...
        success: function (data) {
            ...
            srno+=1;
                var id = item.id;
                var modelname = item.renewalfrom;
                rows += "<tr>" +
                "<td>" + id + "</td>" +
                "<td>" + srno + "</td>" +
                    "</td><td>" + modelname + ' ' +
...
function AddRecord() {
   ...
   // name = sentenceCase(name);
    var model = {};
    model.renewalFrom = name;
    $.ajax({
        type: "POST",
        url: "servicelastrenewalfrom.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "servicelastrenewalfrom.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            ...
            if (result.d == "10") {
                ...
                var modelname = json[0].renewalfrom;
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "servicelastrenewalfrom.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "servicelastrenewalfrom.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
