...
$(document).ready(function () {
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllPaymentMethodswithBank",
        dataType: "json",
        ...
        error: function (response) {
            ...
            $.notify("BOOM payment method!", "error");
        }
...
//    $.ajax({
//        type: "POST",
//        url: "testcolumnsearchdatatable.aspx/GetInvoiceNoByAccountTypeID",
...
//}
 ...
 $("#Showoverlay").show();
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllBanksList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
...
//// $("#ddlPaymentTo").empty();
 ...
 $('#ddlPaymentTo').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllVendorsList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlPaymentTo').find('option:not(:first)').remove();
 ...
 $("#Showoverlay").show();
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllEmployeesList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlPaymentTo').find('option:not(:first)').remove();
 ...
 $("#Showoverlay").show();
    ...
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllCustomersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
        ////$('#ddlPaymentTo').find('option:not(:first)').remove();
...
//// $("#ddlPaymentTo").empty();
 ...
 $('#ddlPaymentTo').find('option:not(:first)').remove();
    $.ajax({
        type: "POST", url: "testcolumnsearchdatatable.aspx/GetAllGeneralLedgersList",
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
       ///// $('#ddlPaymentTo').find('option:not(:first)').remove();
        ...
        error: function (response) {
            ///alert(response.responseText);
            $.notify("BOOM general ledgers!", "error");
            $("#Showoverlay").show();
        }
...
function BindDataTable() {
 ...
 $("#tblRecords").dataTable().fnDestroy();
  ...
  $('#tblRecords thead th').each(function () {
                var title = $(this).text();
                ////alert(title)
//                if(title.trim()!="Sr. Number")
//                {
//                $(this).html(title+' <input type="text" class="col-search-input" placeholder="Search ' + title + '" />');
//                }

                if(title.trim()=="Description" || title.trim()=="Mode")
                {
                $(this).html(title+' <input type="text" class="col-search-input" placeholder="Search ' + title.trim() + '" />');
                }
 ...
 var searchDt = 0;
            ...
            if (searchValue != "") {
             ...
             /// alert("1");
              if(pd!="")
              {
                searchDataBy+="paymentdt=" + pd;
              }
              if(mode!="")
              {
                searchDataBy+="accounttype=" + mode;
              }
              /// alert(searchDataBy);
             /////////////End For Searchparameter /////////

  searchDt = $("#txtDate").val();
 ...
 var i = 1;
      ...
      var table =     $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'TestPaymentTransactionsHandler.ashx/GetPaymentTransactionData?searchdt=' + searchDt + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,

            /////sAjaxSource: 'TestPaymentTransactionsHandler.ashx/GetValues?searchdt=' + searchDt + '&searchvalue=' + searchDataBy,
...
//    var paymenttobank = $("#ddlPaymentToOtherBank :selected").text();
    ...
    var isspecialremarks = "";
    if ($('#chkSpecialRemarks').prop('checked')) {
        isspecialremarks = "1";
    } else {
        isspecialremarks = "0";
    }
   ...
   // name = sentenceCase(name);
    ...
    model.isspecialremarks=isspecialremarks;

    $.ajax({
        type: "POST",
        url: "testcolumnsearchdatatable.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "testcolumnsearchdatatable.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            ...
            if (result.d == "10") {
                ...
                var isspecialremarks = json[0].isspecialremarks;
                if (isspecialremarks == "1") {
                
                    $('#chkSpecialRemarks').prop('checked', true);
                } else {
                 
                    $("#chkSpecialRemarks").prop('checked', false);
                }
   ...
   /// alert(pmodebankname + "0" + oldpmodebankname);
    ...
    model.oldpaymenttobank = oldpaymenttobank;
      ...
      ////alert(oldpmodebankname);
        ...
        $.ajax({
            type: "POST",
            url: "testcolumnsearchdatatable.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
const myArray = empdata.split(",");
    ...
    model.accounttypeid=accounttypeid;
        ...
        $.ajax({
            type: "POST",
            url: "testcolumnsearchdatatable.aspx/DeleteRecord",
           //// data: '{ id :' + id + '}',
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
