...
var show = false;
 ...
 var buttons = [''];
  ...
  if (show) {
    ...
    $.ajax({
        type: "POST",
        url: "yardfinancecompany.aspx/GetAllData",
        data: '',
...
function AddRecord() {
    ...
    var fcname = $('[id*=txtName]').val();
   // name = sentenceCase(name);
    var model = {};
    model.fcname = fcname;
    $.ajax({
        type: "POST",
        url: "yardfinancecompany.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "yardfinancecompany.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "yardfinancecompany.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "yardfinancecompany.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
