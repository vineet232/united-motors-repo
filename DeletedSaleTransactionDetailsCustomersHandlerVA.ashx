<%@ WebHandler Language="C#" Class="DeletedSaleTransactionDetailsCustomersHandlerVA" %>
...
public class DeletedSaleTransactionDetailsCustomersHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForSaleTransactionCustomersDeletedVA", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from salesTransactionDetailsCustomersDeletedVA  where invoicetypeid=7", con);
            con.Open();
