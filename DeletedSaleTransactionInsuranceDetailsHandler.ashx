<%@ WebHandler Language="C#" Class="DeletedSaleTransactionInsuranceDetailsHandler" %>
...
public class DeletedSaleTransactionInsuranceDetailsHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForSaleTransactionInsuranceDeleted", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from salesTransactionDetailsInsuranceDeleted where  accounttypeid=1", con);
            con.Open();
