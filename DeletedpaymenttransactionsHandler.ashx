<%@ WebHandler Language="C#" Class="DeletedpaymenttransactionsHandler" %>
...
public class DeletedpaymenttransactionsHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPaymentTransactionDeleted", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from paymentTransactionDetailsDeleted ", con);
            con.Open();
