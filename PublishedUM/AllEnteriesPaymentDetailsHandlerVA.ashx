<%@ WebHandler Language="C#" Class="AllEnteriesPaymentDetailsHandlerVA" %>
...
public class AllEnteriesPaymentDetailsHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPaymentTransactionAllEnteriesVA", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from paymentTransactionDetailsAllEnteriesVA", con);
            con.Open();
