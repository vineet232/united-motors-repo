<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="AllEnteriesPaymentVA, App_Web_h5d101sg" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<%--<script src="js/jquery.min.js" type="text/javascript"></script>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/allenteriespaymentsVA.js" type="text/javascript"></script>
                            ...
                            <thead>
                                <tr>
                                   <%-- <th>
                                    ...
                                    <th>
                                        Account Type / Payment To
                                       
                                    </th>
                                    <th>
                                        Bank / Mode / Receipt / Amount
                                    </th>
                                   <th>
                                       Old Bank / Mode / Receipt / Amount
                                    </th>
                                     <th>
                                        Old Date / Account Type / Payment To / Remarks
                                    </th>
                                     <th>
                                        Entered Details
                                    </th>
