<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="AllEnteriesPurchaseVA, App_Web_1ssuryoo" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<%--<script src="js/jquery.min.js" type="text/javascript"></script>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/AllEnteriesPurchasesVA.js" type="text/javascript"></script>
                            ...
                            <thead>
                                <tr>
                                   <%-- <th>
                                    ...
                                    <th>
                                        Account Type / Vendor Name
                                       
                                    </th>
                                    <th>
                                        Invoice Type / Invoice No / Mode / Amount 
                                    </th>
                                   <th>
                                       Old Purchase. Dt / Vendor Name
                                    </th>
                                     <th>
                                        Old Inv. Type / Inv No / Mode / Amount
                                    </th>
                                     <th>
                                        Entered Details
                                    </th>
