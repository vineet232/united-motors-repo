<%@ WebHandler Language="C#" Class="AllEnteriesPurchasesHandler" %>
...
public class AllEnteriesPurchasesHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPurchaseAllEnteries", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from purchaseTransactionDetailsAllEnteries ", con);
            con.Open();
