<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="AllEnteriesSaleTrnInsurance, App_Web_gdx0w2k3" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<%--<script src="js/jquery.min.js" type="text/javascript"></script>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/allenteriesinsurance.js" type="text/javascript"></script>
                            ...
                            <thead>
                                <tr>
                                   <%-- <th>
                                    ...
                                    <th>
                                        Account Type / Invoice No / Veh Chasis / Sales Executive
                                       
                                    </th>
                                    <th>
                                        Vendor Name / Mode / Amount
                                    </th>
                                   <th>
                                       Payout / Mode / Amount
                                    </th>
                                    ...
                                    <th>
                                        Old Invoice No / Veh Chasis / Sales Executive
                                       
                                    </th>
                                    <th>
                                       Old Vendor Name / Mode / Amount
                                    </th>
                                   <th>
                                      Old Payout / Mode / Amount
                                    </th>
                                     <th>
                                       Old Sales / Mode / Amount
                                    </th>
                                     <th>
                                        Entered /
