...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterCashinHandOpeningBalance.aspx/GetAllData",
        data: '',
...
//    }
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "masterCashinHandOpeningBalance.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterCashinHandOpeningBalance.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//    }
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterCashinHandOpeningBalance.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterCashinHandOpeningBalance.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
