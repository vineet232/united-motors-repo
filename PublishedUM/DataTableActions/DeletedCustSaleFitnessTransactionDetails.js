...
function BindDataTable() {
 ...
 var i = 1;
            ...
            $('#tblRecords').DataTable({
             ...
             bServerSide: true,
             sAjaxSource: 'DeletedSaleTransactionFitnessCustomersHandler.ashx/GetSaleTransactionDetailsCustomersData',
                sServerMethod: 'post',
                "processing": true,
                "columns": [
                 { "data": "id" ,
...
///////alert(id);
    if (confirm('Are you sure to restore this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "deletedEnteriesSaleTrnFitness.aspx/RestoreRecord",
            data: '{ id :' + id + '}',
