...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterdesignation.aspx/GetAllData",
        data: '',
...
function AddRecord() {
    ...
    var designation = $('[id*=txtDesignation]').val();
   // name = sentenceCase(name);
    var model = {};
    model.designation = designation;
    $.ajax({
        type: "POST",
        url: "masterdesignation.aspx/SaveRecord",
        ...
        success: function (r) {
            ...
            if (r.d == 10) {
                ...
                if (r.d == 20 || r.d == 30) {
                    ...
                    if (r.d == 30) {
                        $.notify("Error!! designation cannot be blank!", "error");
                        $('[id*=txtDesignation]').focus();
                        return;
                    }
                }
                else {
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterdesignation.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//                var modelname = json[0].modelname;
                ...
                $('#txtDesignation').val(json[0].designation);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterdesignation.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterdesignation.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
