...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masteremissiontype.aspx/GetAllData",
        data: '',
...
function AddRecord() {
    ...
    var emissiontype = $('[id*=txtname]').val();
   // name = sentenceCase(name);
    var model = {};
    model.emissiontype = emissiontype;
    $.ajax({
        type: "POST",
        url: "masteremissiontype.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masteremissiontype.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//                var modelname = json[0].modelname;
                ...
                $('#txtname').val(json[0].emissiontype);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masteremissiontype.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masteremissiontype.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
