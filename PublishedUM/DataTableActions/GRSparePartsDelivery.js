...
//    });
    ...
    $.ajax({
        type: "POST", url: "sparepartsdeliverygr.aspx/GetModelName",
        dataType: "json",
      ...
      $.ajax({
        type: "POST", url: "sparepartsdeliverygr.aspx/GetAllEmployees",
        dataType: "json",
        contentType: "application/json", 
        success: function (res) {
            $.each(res.d, function (data, value) {
...
var slip ="0";
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetChallanNo",
        data: '',
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
...
function BindDataTable(statusid) {
 ...
 $("#tblRecords").dataTable().fnDestroy();
    ...
    { "visible": false, "targets": [] }
                ...
                bServerSide: true,
                sAjaxSource: 'SparePartsDeliverygrHandler.ashx?statusid='+ statusid,
                sServerMethod: 'post',
                "processing": true,
     ...
     ///alert(vehno);
      ...
      var model = {};
        ...
        model.vehno=vehno;
         ...
         $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/TransfertoSlipPage",
            data: '{ model :' + JSON.stringify(model) + '}',
            //////data: '{slipno : ' + slipno + '}',
...
function OpenChallanDetails(empdata)
{
    ...
    if(statusid=="2")
    {
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/ReopenChallan",
            data: '{ model :' + JSON.stringify(model) + '}',
            //////data: '{slipno : ' + slipno + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
//    /////alert(paymentmode + modelname + status);
  ...
  $('#btnUpdateDetails').hide();
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetAllDataByChallanno",
...
//////        table.row($(this).parents('tr')).remove().draw();
 ...
 var challanno =  $('#txtDSlipNo').val();
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/ReturnPartRecordDetails",
            //////data: '{ id :' + id + '}',
             data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
