...
//    });
    ...
    $("#ddlModel").select2();
     ...
     $.ajax({
        type: "POST", url: "sparepartsdeliverygr.aspx/GetVehiclenoAndModel",
        dataType: "json",
        contentType: "application/json", 
        success: function (res) {
            $.each(res.d, function (data, value) {

                $("#ddlModel").append($("<option></option>").val(value.id).html(value.vehicleno));
            })
        }
        ,
...
function ddlModel_Change()
{

   var vehno =  $("#ddlModel :selected").text();
    var model={};
    model.vehicleno=vehno;
    ...
    //////alert(JSON.stringify(model));
     ...
     $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetModelName",
...
////             var json = JSON.stringify(result.d);
////             alert(json);
           // alert(jsondata[0].vehmodel);
                $('#txtModel').val(result.d);
    ...
    //$.ajax({
//    type : "POST",
//   url : "sparepartsdelivery.aspx/GetModelName",
//   data : '{ model :' + JSON.stringify(model) + '}',
//   contentType: "application/json; charset=utf-8",
//   dataType: "json",
//   async : "false",
...
////        type: "POST",
////        url: "sparepartsdeliverygr.aspx/SaveRecord",
////        data: '{ model :' + JSON.stringify(model) + '}',
////        contentType: "application/json; charset=utf-8",
////        dataType: "json",
////        async: false,
...
//            $("#txtModel").val(jsondata[0].vehmodel);
//            }
//         },
//   error: function (errormessage) 
//   {
...
function GetPartDetailsbyPartNo()
 {
   ...
   ///// alert(partNo);
    ...
    $("#Showoverlay").show();
     $.ajax({
         type: "POST",
         url: "sparepartsdeliverygr.aspx/GetPartDescByPartNo",
         //////data: '{ partno :' + partNo + '}',
          data: '{ model :' + JSON.stringify(model) + '}',
         dataType: "json",
         contentType: "application/json",
...
var slip ="0";
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetSlipNo",
        data: '',
        dataType: "json",
        contentType: "application/json",
        success: function (res) {
...
function BindDataTable(statusid) {
 ...
 //////////////////For Search Field and value ///////////////////////
    ...
    /////////GetAllSllipsList
                bServerSide: true,
                sAjaxSource: 'SparePartsDeliverygrHandler.ashx?statusid='+ statusid + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,
                sServerMethod: 'post',
                "processing": true,
...
function OpenSlipDetails(empdata)
{
    ...
    if(statusid=="2")
    {
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/ReopenSlip",
            data: '{ model :' + JSON.stringify(model) + '}',
            //////data: '{slipno : ' + slipno + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function AddRecord() {
   ...
   ////// var customername = $('[id*=txtCustomerName]').val();
    var vehicleno = $("#ddlModel :selected").text();   ///// $('[id*=txtVehChasisNo]').val();
   ...
   ///// model.slipdate = slipdate;
    model.customername = "GLR";
    model.vehicleno = vehicleno;
    model.mobileno = "0000000000";
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
...
////    }
   ...
   ////// model.paymentmodeid=0;
    ...
    /////alert(paymentmode + modelname + status);
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//////        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
////        $.ajax({
////            type: "POST",
////            url: "sparepartsdeliverygr.aspx/PrintSlip",
////            data: '{ id :' + id + '}',
////            contentType: "application/json; charset=utf-8",
////            dataType: "json",
...
//////    }
  ...
  $('#btnUpdateDetails').hide();
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetAllDataBySlipNo",
       data: '{slipno : ' + slipno + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//    }
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/SaveRecordDetails",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function EditRecordbyIDDetails(id) {
    ...
    $.ajax({
        type: "POST",
        url: "sparepartsdeliverygr.aspx/GetRecordbyIDDetails",
...
////    }
   ...
   var slipno= $('#txtDSlipNo').html();
    ...
    /////alert(paymentmode + modelname + status);
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/UpdateRecordDetails",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//////        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "sparepartsdeliverygr.aspx/DeleteRecordDetails",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
