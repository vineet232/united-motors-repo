...
function AddRecord() {
    ...
    var gvw = $('[id*=txtName]').val();
   // name = sentenceCase(name);
    var model = {};
    model.gvw = gvw;
    $.ajax({
        type: "POST",
        url: "masterGVW.aspx/SaveRecord",
        ...
        success: function (r) {
            ...
            if (r.d == 10) {
                ...
                if (r.d == 20 || r.d == 30) {
                    ...
                    if (r.d == 30) {
                        $.notify("Error!! GVW cannot be blank!", "error");
                        $('[id*=txtName]').focus();
                        return;
                    }
                }
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterGVW.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterGVW.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            success: function (r) {
                ...
                if (r.d == 10 || r.d == 20 || r.d == 30) {
                    ...
                    if (r.d == 20) {
                        $.notify("Error!! GVW already exists!", "error");
                        return;
                    }
                    if (r.d == 30) {
                        $.notify("Error!! GVW cannot be blank!", "error");
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterGVW.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
