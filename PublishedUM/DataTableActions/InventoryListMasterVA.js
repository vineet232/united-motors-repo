 ...
 function GetPartDetailsbyPartNo()
 {
   ...
   //// alert(partNo);
    ...
    $("#Showoverlay").show();
     $.ajax({
         type: "POST",
         url: "inventorylistVA.aspx/GetPartDescByPartNo",
         ///////data: '{ partno :' + partNo + '}',
...
function BindDataTable() {
 ...
 $("#tblRecords").dataTable().fnDestroy();
    ...
    { "visible": false, "targets": [] }
                ...
                bServerSide: true,
                sAjaxSource: 'inventoryListHandlerVA.ashx/GetAllList',
                sServerMethod: 'post',
                "processing": true,
...
////    model.lastreceived = lastreceived;
    ...
    $.ajax({
        type: "POST",
        url: "inventorylistva.aspx/SaveRecord",
        data: '{ model :' + JSON.stringify(model) + '}',
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "inventorylistVA.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//        model.qty = qty;
        ...
        $.ajax({
            type: "POST",
            url: "inventorylistVA.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "inventorylistVA.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function ShowTransactionDetails(partno) {
    ...
    $.ajax({
        type: "POST",
        url: "inventorylistVA.aspx/GetTransactionDetailsbyPartNo",
        data: "{ model :" + JSON.stringify(model) + "}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
