...
$(document).ready(function () {
    ...
    $.ajax({
        type: "POST", 
        url: "masterlineofbusiness.aspx/GetAllEmissionTypeList",
        dataType: "json",
...
function GetData() {
    ...
    $.ajax({
        type: "POST",
        url: "masterlineofbusiness.aspx/GetAllData",
        //// data: '',
...
function AddRecord() {
    ...
    var lineofbusiness = $('[id*=txtname]').val();
    var emissiontypeid = $("#ddlemissiontype :selected").val();
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "masterlineofbusiness.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "masterlineofbusiness.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//                var modelname = json[0].modelname;
                ...
                $('#txtname').val(json[0].lineofbusiness);
...
function UpdateRecord() {
    ...
    if (id > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "masterlineofbusiness.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
function DeleteRecord(id) {
    if (confirm('Are you sure delete this record?')) {
        ...
        $.ajax({
            type: "POST",
            url: "masterlineofbusiness.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
