...
var slip ="0";
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/GetSlipNo",
        data: '',
        dataType: "json",
...
function BindDataTable(statusid)  {
 ...
 //////////////////For Search Field and value ///////////////////////
    ...
    { "visible": false, "targets": [] }
                ...
                bServerSide: true,
                sAjaxSource: 'SlipDetailsHandlerVA.ashx?statusid='+ statusid + '&searchfield=' + searchfield + '&searchvalue=' + searchvalue,
                sServerMethod: 'post',
                "processing": true,
                     ...
                     render: function ( data, type, row )
                        {
                            ...
                            if(row.statusid=="2")
                            {
                                return  "<div style='color:red;'>" + "VA/" +  row.slipno + "</div>" + "<br/>" + row.slipdate ;
                            }
                     }
                  ...
                  /////  { "data": "paymentmode" },
...

                   {
                       ...
                       render: function ( data, type, row )
                       {
                            if(row.statusid=="1")
                            {
                                return '<a href="#" onclick="OpenSlipDetails(\'' + row.id + ',' + row.customername + ',' + row.vehicleno + ',' + row.statusid  + ',' + row.isslipcancelled + '\'\)">  <i class="glyphicon glyphicon-plus text-primary" style="font-size:x-large;"></i> </a>';
                            }
                            if(row.statusid=="2")
                            {
                                return '    <a href="#" onclick="OpenSlipDetails(\'' + row.id + ',' + row.customername + ',' + row.vehicleno + ',' + row.statusid + ',' + row.isslipcancelled  + '\'\)">  <i class="glyphicon glyphicon-open text-success" style="font-size:x-large;"></i> </a>'
                               
                                +
                                 ' &nbsp; &nbsp; <a href="#"  onclick="ShowSlipDetails(\'' + row.id + ',' + row.customername + ',' + row.vehicleno + ',' + row.statusid + ',' + row.isslipcancelled  + '\'\)"><i class="glyphicon glyphicon-eye-open text-primary" style="font-size:x-large;"></i></a>';
   ...
   function CancelSlipDetails(id)
   {
    ...
    model.id=id;
     $("#Showoverlay").show();
        $.ajax({
            type: "POST",
            url: "slipdetailsva.aspx/CancelSlipMaster",
           ///// data: '{ id :' + id + '}',
...
function OpenSlipDetails(empdata)
{
    ...
    let customername = myArray[1];
     ...
     let iscancelled = myArray[4];
    //alert(empname);

    if(iscancelled=="1")
    {
        $.notify("Error!! Slip cancelled. Not allowed!", "error");
        return;
    ...
    if(statusid=="2")
    {
        ...
        $.ajax({
            type: "POST",
            url: "slipdetailsVA.aspx/ReopenSlip",
            data: '{ model :' + JSON.stringify(model) + '}',
            //////data: '{slipno : ' + slipno + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
//    }
   ...
   ////// model.paymentmodeid=0;
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/SaveRecord",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function EditRecordbyID(id) {
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/GetRecordbyID",
        data: '{ id :' + id + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
////    }
   ...
   ////// model.paymentmodeid=0;
    ...
    /////alert(paymentmode + modelname + status);
        ...
        $.ajax({
            type: "POST",
            url: "slipdetailsVA.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//////        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "slipdetailsVA.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
////        $.ajax({
////            type: "POST",
////            url: "slipdetailsVA.aspx/PrintSlip",
////            data: '{ id :' + id + '}',
////            contentType: "application/json; charset=utf-8",
////            dataType: "json",
   ...
   function GetPartDetailsbyPartNo()
 {
   ...
   ///// alert(partNo);
    ...
    $("#Showoverlay").show();
     $.ajax({
         type: "POST",
         url: "slipdetailsVA.aspx/GetPartDescByPartNo",
         //////data: '{ partno :' + partNo + '}',
          data: '{ model :' + JSON.stringify(model) + '}',
         dataType: "json",
         contentType: "application/json",
  ...
  $('#btnUpdateDetails').hide();
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/GetAllDataBySlipNo",
       data: '{slipno : ' + slipno + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
//    }
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/SaveRecordDetails",
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
...
function EditRecordbyIDDetails(id) {
    ...
    $.ajax({
        type: "POST",
        url: "slipdetailsVA.aspx/GetRecordbyIDDetails",
...
////    }
   ...
   var slipno= $('#txtDSlipNo').html();
    ...
    /////alert(paymentmode + modelname + status);
        ...
        $.ajax({
            type: "POST",
            url: "slipdetailsVA.aspx/UpdateRecordDetails",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
var model = {};
    ...
    model.slipno = $('#txtDSlipNo').html();
        ...
        $.ajax({
            type: "POST",
            url: "slipdetailsVA.aspx/DeleteRecordDetails",
           ////// data: '{ id :' + id + '}',
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
