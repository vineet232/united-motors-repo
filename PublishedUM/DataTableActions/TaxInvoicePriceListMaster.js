...
//////// $.ajax({
////////        type: "POST", url: "TaxInvoiceUploadPriceList.aspx/GetFinanceCompanyName",
////////        dataType: "json",
...
////////    $.ajax({
////////        type: "POST", url: "TaxInvoiceUploadPriceList.aspx/GetModelName",
////////        dataType: "json",
////////        contentType: "application/json", 
////////        success: function (res) {
////////            $.each(res.d, function (data, value) {
...
////function ddlTruckCompanies_SelectedIndexChanged(obj) {
////    
////    var id = obj.id;
...
function BindDataTable() {
    ...
    var truckcompval = $("#ddlTruckCompanies :selected").val();
    var truckcomptext = $("#ddlTruckCompanies :selected").text();

    ////    alert(truckcompval + "t" + truckcomptext);
    ////    return;
    ...
    { "visible": false, "targets": [] }
            ...
            bServerSide: true,
            sAjaxSource: 'TaxInvoicePriceListHandler.ashx?compval=' + truckcompval,
            sServerMethod: 'post',
            "processing": true,
            ...
            //////  { "data": "purchaseprice"    },
                ...
                { "data": "purchaseprice" },
                 ...
                 { "data": "updatedby",
                     render: function (data, type, row) {
                         var udate = moment(row.createdon).format('DD-MMM-YYYY hh:mm A')

                         return "<div class='text-nowrap'>" + row.createdby + '<br/>(' + udate + ')' + "</div>";
                     }
                 },
...
function AddRecord() {
   ...
   // name = sentenceCase(name);
    ...
    $.ajax({
        type: "POST",
        url: "TaxInvoiceUploadPriceList.aspx/SaveRecord",
...
function EditRecordbyID(id) {
    ...
    var model = {};
    model.id = id;
    model.truckcompid = truckcompval;

    //////alert(model.truckcompid);

    $('#recordID').val("0");
   
    $.ajax({
        type: "POST",
        url: "TaxInvoiceUploadPriceList.aspx/GetRecordbyID",
        ///////data: '{ id :' + id + '}',
        data: '{ model :' + JSON.stringify(model) + '}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function UpdateRecord() {
    ...
    if (id > 0) {
       ...
       /////// model.product = product;
        ...
        $.ajax({
            type: "POST",
            url: "TaxInvoiceUploadPriceList.aspx/UpdateRecord",
            data: '{ model :' + JSON.stringify(model) + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
...
//        table.row($(this).parents('tr')).remove().draw();
        ...
        $.ajax({
            type: "POST",
            url: "TaxInvoiceUploadPriceList.aspx/DeleteRecord",
            data: '{ id :' + id + '}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
