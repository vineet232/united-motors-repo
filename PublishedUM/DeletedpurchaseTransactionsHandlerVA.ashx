<%@ WebHandler Language="C#" Class="DeletedpurchaseTransactionsHandlerVA" %>
...
public class DeletedpurchaseTransactionsHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPurchaseTransactionDeletedVA", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from purchaseTransactionDetailsDeletedVA ", con);
            con.Open();
