<%@ WebHandler Language="C#" Class="InsuranceClaimsPolicyUploadHandlerFS" %>
...
public class InsuranceClaimsPolicyUploadHandlerFS : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.Files.Count > 0)
        {
            ...
            {
                //Set the Folder Path.
                string folderPath = context.Server.MapPath("~/UploadedSurveyorFilesFS/");
                ...
                if (claimid != "" && claimid != "0")
                {
                    ...
                    int result = InsuranceClaimsModel.UploadFilesFS(obj);
                    if (result == 0)
                    {
