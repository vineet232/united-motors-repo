<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="MasterEnteries, App_Web_h5d101sg" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table width="100%" style="vertical-align: top;" align="center" class="table table-responsive">
                <tr valign="top">
                    <td valign="top">
                        <b style="color: Blue;"><u>MASTER ENTERIES (Estimate)</u></b>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="true" PageSize="10"
                            CssClass="table table-responsive" OnPageIndexChanging="PageIndexChanging" OnSelectedIndexChanged="GridIndexChanged"
