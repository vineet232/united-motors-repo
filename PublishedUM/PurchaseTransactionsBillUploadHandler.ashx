<%@ WebHandler Language="C#" Class="PurchaseTransactionsBillUploadHandler" %>
...
public class PurchaseTransactionsBillUploadHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.Files.Count > 0)
        {
            ...
            {
                //Set the Folder Path.
                string folderPath = context.Server.MapPath("~/UploadedPurchaseBills/");
                ...
                if (pid != "" && pid != "0")
                {
                    PurchaseTransactionDetailsFunctions obj = new PurchaseTransactionDetailsFunctions();
                    ...
                    int result = PurchaseTransactionDetailsFunctions.UploadFiles(obj);
                    if (result == 0)
                    {
