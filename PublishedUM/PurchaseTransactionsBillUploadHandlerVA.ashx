<%@ WebHandler Language="C#" Class="PurchaseTransactionsBillUploadHandlerVA" %>
...
public class PurchaseTransactionsBillUploadHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.Files.Count > 0)
        {
            ...
            {
                //Set the Folder Path.
                string folderPath = context.Server.MapPath("~/UploadedPurchaseBillsVA/");
                ...
                if (pid != "" && pid != "0")
                {
                    PurchaseTransactionDetailsFunctionsVA obj = new PurchaseTransactionDetailsFunctionsVA();
                    ...
                    int result = PurchaseTransactionDetailsFunctionsVA.UploadFiles(obj);
                    if (result == 0)
                    {
