<%@ WebHandler Language="C#" Class="SaleTransactionDetailsCustomersHandler" %>
...
public class SaleTransactionDetailsCustomersHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        //int displayLength = 10; // int.Parse(context.Request["iDisplayLength"]);
        //int displayStart = 0; // int.Parse(context.Request["iDisplayStart"]);
        //int sortCol = 0; // int.Parse(context.Request["iSortCol_0"]);
        //string sortDir = "asc"; // context.Request["sSortDir_0"];
        //string search = ""; // context.Request["sSearch"];
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForSaleTransactionCustomers", con);
            ...
            ///////////For Search /////////
            string searchdt = "0";  //context.Request["searchdt"];
