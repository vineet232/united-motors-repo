<%@ WebHandler Language="C#" Class="SparePartsDeliverygrHandler" %>
...
public class SparePartsDeliverygrHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        List<GRSlipDetailsFuncations> listData = new List<GRSlipDetailsFuncations>();
        int filteredCount = 0;
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataSlipMasterGR", con);
            ...
            while (rdr.Read())
            {
                ...
                GRSlipDetailsFuncations listItems = new GRSlipDetailsFuncations();
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tblSlipmastergr", con);
            con.Open();
