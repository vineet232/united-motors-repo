...
<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="TaxInvoiceUploadPriceList, App_Web_1ssuryoo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/TaxInvoicePriceListMaster.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-md-12 well well-sm" align="center" >
        <div class="col-md-3">
            ...
            <br />
            <asp:DropDownList ID="ddlTruckCompanies" runat="server" CssClass="form-control"  ClientIDMode="Static" onchange="BindDataTable()" >
        ...
        <div class="col-md-6" id="divUpload" runat="server" visible="false">
            <div class="col-md-6">
                <br />
