<%@ WebHandler Language="C#" Class="TestPaymentTransactionsHandler" %>
...
public class TestPaymentTransactionsHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("TestDataForPaymentTransactionNew", con);
