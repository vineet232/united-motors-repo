<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="adminuserslist, App_Web_1ssuryoo" %>
                        ...
                        <div class="col-md-12 well well-sm">
                           ...
                           <%-- <div class="col-md-3">
                            ...
                            <br />
                                ...
                                <asp:Label ID="ErrLabel" runat="server" Font-Bold="true" Text="" ForeColor="Red"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            ItemStyle-Width="20px" />
                                ...
                                <asp:TemplateField HeaderText="User Name">
                                 ...
                                 <asp:TemplateField HeaderText="Location" >
                                    <ItemTemplate>
                                     <asp:Label ID="lbluserlocation" runat="server" Visible="false" Text='<%# Bind("userlocation") %>'></asp:Label>
                                        <asp:Label ID="lbluserlocationname" runat="server" Text='<%# Bind("userlocationname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
