<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="empwiseattendreport, App_Web_h5d101sg" %>
                              ...
                              <%--  <asp:TemplateField HeaderText="ID" Visible="false">
                                ...
                                <asp:TemplateField HeaderText="Employee Name">
                                 ...
                                 <asp:TemplateField HeaderText="Attendance Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblattenddt" runat="server" Text='<%# Bind("attenddt", "{0:dd-MMM-yyyy}" ) %>'></asp:Label>
                                 ...
                                 <asp:TemplateField HeaderText="Present">
                                    <ItemTemplate>
                                     <asp:Label ID="lblPresent" ForeColor="Green" runat="server" Text='<%# Bind("Present") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Absent">
                                    <ItemTemplate>
                                     <asp:Label ID="lblAbsent" ForeColor="Red" runat="server" Text='<%# Bind("Absent") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
//                }
            ...
            title: 'Account of -' + $("#ddlEmployees :selected").text()  ,
