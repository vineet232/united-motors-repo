<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="billTotal, App_Web_gdx0w2k3" %>
            ...
            <td>
                <table width="80%">
                    <tr>
                        <td>
                            From Date:
                            <asp:TextBox ID="txtFirstDate" MaxLength="10" autocomplete="off" onfocus="showCalendarControl(this);"
                            ...
                            &nbsp; To Date:
                            <asp:TextBox ID="txtSecondDate" MaxLength="10" autocomplete="off" onfocus="showCalendarControl(this);"
                                ToolTip="MM/DD/YYYY" Width="70px" runat="server"></asp:TextBox>
        ...
        <tr>
            <td>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="billTotalRpt.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetData" TypeName="billsTotalDSTableAdapters.BILLMASTableAdapter">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtFirstDate" DefaultValue="1/1/1900" Name="date1"
                            PropertyName="Text" Type="DateTime" />
                        <asp:ControlParameter ControlID="txtSecondDate" DefaultValue="1/1/1900" Name="date2"
                            PropertyName="Text" Type="DateTime" />
                    </SelectParameters>
