<%@ WebHandler Language="C#" Class="inventoryDataHandler" %>
...
public class inventoryDataHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPriceListMaster", con);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tblPriceListMaster", con);
            con.Open();
