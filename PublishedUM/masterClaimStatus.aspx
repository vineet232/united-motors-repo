<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="masterClaimStatus, App_Web_h5d101sg" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/ClaimStatusMaster.js" type="text/javascript"></script>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="Claim Status" 
