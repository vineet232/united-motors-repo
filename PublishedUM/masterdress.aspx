<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="masterdress, App_Web_1ssuryoo" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/DressMaster.js" type="text/javascript"></script>
        ...
        <ContentTemplate>
            <div>
                ...
                <div class="container">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        <span class="input-group-addon"><i class="fa fa-square fa-fw" aria-hidden="true"></i>
                                                        </span>
                                                        <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="Dress Name" />
                                                    </div>
                 ...
                 <div class="myStockModal">
                    <div class="modal fade" id="myStockModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                     ...
                                                     <input type="hidden" name="recordStockID" id="recordStockID" value="">
                                                        <div class="input-group margin-bottom-sm">
                                                            <span class="input-group-addon"><i class="fa fa-square fa-fw" aria-hidden="true"></i>
                                                            </span>
                                                            <input type="text" class="form-control" id="txtStockDress" maxlength="50" placeholder="Dress Name"
                                                                readonly />
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <div class="input-group margin-bottom-sm">
                                                            ...
                                                            <input type="text" class="form-control" id="txtStockQty" autocomplete="off" required maxlength="5" onkeypress="return /[0-9]/i.test(event.key)" placeholder="Qty." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtDOS" maxlength="10" placeholder="D.O.S" required
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <br />
                                                        <input type="submit" name="btnAddStock" id="btnAddStock" onclick="btnAddDressStock();" value="Add Stock" class="btn btn-primary" />
                                                    
                                                </div>

                                                <div class="col-md-12">
                                                <br />
                                                    <table width="100%" id="tblDressStockDetails" class="table table-bordered  table-responsive">
                                                        <thead>
                                                            <tr>
                                                                 <th>
                                                                    ID
