<%@ WebHandler Language="C#" Class="purchaseTransactionsHandlerVA" %>
...
public class purchaseTransactionsHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        List<PurchaseTransactionDetailsFunctionsVA> listData = new List<PurchaseTransactionDetailsFunctionsVA>();
        int filteredCount = 0;
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForPurchaseTransactionVA", con);
            ...
            while (rdr.Read())
            {
                PurchaseTransactionDetailsFunctionsVA listItems = new PurchaseTransactionDetailsFunctionsVA();
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from purchaseTransactionDetailsVA ", con);
            con.Open();
