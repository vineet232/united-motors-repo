<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="reportBanksVA, App_Web_y0qsyvj2" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
   <%-- <script src="DataTableActions/ReportBanksVA.js" type="text/javascript"></script>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                       ...
                                       <%-- <select id="ddlBanks" class="form-control" > 
