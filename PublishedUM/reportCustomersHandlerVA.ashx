<%@ WebHandler Language="C#" Class="reportCustomersHandlerVA" %>
...
public class reportCustomersHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForCustomerReportNewVA", con);
            ...
            DataSet ds = ReportsFunctions.GetCustomerOpeningBalanceVA(custID);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tmpCustReportVA ", con);
            con.Open();
