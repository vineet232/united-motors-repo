<%@ WebHandler Language="C#" Class="reportEmployeeHandler" %>
...
public class reportEmployeeHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForEmployeeReport", con);
            ...
            DataSet ds = ReportsFunctions.GetEmployeeOpeningBalance(empID);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tmpEmpReport ", con);
            con.Open();
