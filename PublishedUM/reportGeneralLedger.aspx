<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="reportGeneralLedger, App_Web_y0qsyvj2" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <%--<select id="ddlGeneralLedger" class="form-control" > 
                                            <option value="0" selected="selected">Please Select</option>
                                        </select>--%>

                                          <asp:DropDownList ID="ddlGeneralLedger"  ClientIDMode="Static" runat="server" CssClass="form-control select2-dropdown"></asp:DropDownList>
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Date">
                                    ...
                                    <asp:TemplateField HeaderText="Remarks">
                                        <ItemTemplate>
                                        <asp:Label ID="lblisspecialremarks" Visible="false" runat="server" Text='<%# Bind("isspecialremarks") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Mode of Payment">
                                     ...
                                     <asp:TemplateField HeaderText="Amount Received">
                                        <ItemTemplate>
                                           <span ><i class="fa fa-rupee "></i></span> &nbsp;   <asp:Label ID="lblamountreceived" ForeColor="Red" runat="server" Text='<%# Bind("amountpaid") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
