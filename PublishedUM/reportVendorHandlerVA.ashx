<%@ WebHandler Language="C#" Class="reportVendorHandlerVA" %>
...
public class reportVendorHandlerVA : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForVendorReportNewVA", con);
            ...
            DataSet ds = ReportsFunctions.GetVendorOpeningBalanceVA(vendID);
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tmpVendorReportVA ", con);
            con.Open();
