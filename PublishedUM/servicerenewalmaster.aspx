<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="servicerenewalmaster, App_Web_y0qsyvj2" %>
               ...
               <%-- <div id="divShowExport" class="col-md-12" align="right" style="background-color:White !important;">
                ...
                <div >
                    ...
                    <div class="row well well-sm">
                        ...
                        <div class="col-md-5">
                             Entry Date From (MM/dd/yyyy):
                                <br />
                                <div class="input-group margin-bottom-sm">
                                    <span class="input-group-addon"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i>
                                    </span>
                                    <input type="text" class="form-control" id="txtEntryDate" name="txtEntryDate" maxlength="10" placeholder="Entry Date"
                                        onkeydown="return false;" ondrop="return false;" onpaste="return false;" autocomplete="off" />
                                </div>
                                
                                 <div ><input type="radio" checked="checked" name="rddttype" id="dtentrydt" /> Entry Date </div>
                                  <br />
                                  <%--  <asp:Button ID="btnShowdatabyentryDate" runat="server" CssClass="btn btn-primary" Text="Show Data" OnClick="ShowFilteredDataByEntryDate_Click" />--%>
                            </div>
                            <div class="col-md-5">
                             Entry Date To (MM/dd/yyyy):
                                <br />
                                <div class="input-group margin-bottom-sm">
                                    <span class="input-group-addon"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i>
                                    </span>
                                    <input type="text" class="form-control" id="txtEntryTo" name="txtEntryTo" maxlength="10" placeholder="Entry Date"
                                        onkeydown="return false;" ondrop="return false;" onpaste="return false;" autocomplete="off" />
                                </div>
                                
                              <div ><input type="radio" name="rddttype" id="dtsaledt" /> Vehicle Sale Date </div>
                                 <br />
                               <button id="Button1" type="button" runat="server" class="btn btn-primary" onclick="ShowFilteredDataByEntryDate()">
                                    Show Details </button>
                            </div>
                        </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form>
                                     <input type="hidden" name="recordID" id="recordID" value="">
                                      <input type="hidden" name="hdnnextserviceonkmfrom" id="hdnnextserviceonkmfrom" value="">
                                       <input type="hidden" name="hdnnextserviceonkmto" id="hdnnextserviceonkmto" value="">
                                        <input type="hidden" name="hdnnextservicefromdt" id="hdnnextservicefromdt" value="">
                                       <%--  <input type="hidden" name="hdnnextservicetodt" id="hdnnextservicetodt" value="">--%>
                                          <input type="hidden" name="hdnnextservicetype" id="hdnnextservicetype" value="">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-4" style="display:none;">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddlModel" class="form-control"  style="width:100%;" onchange="ddlModel_SelectedIndexChanged()" >
                                                ...
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddlemissiontype" class="form-control"  style="width:100%;" onchange="BindLineofBusiness()" >
                                                            <option value="0">Please Select</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                 <div class="col-md-4">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddllineofbusiness" class="form-control"  style="width:100%;" onchange="BindParentProductLine()" >
                                                            <option value="0">Please Select</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddlparentproductline" class="form-control"  style="width:100%;" onchange="BindProductLine()" >
                                                            <option value="0">Please Select</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddlproductline" class="form-control"  style="width:100%;" onchange="BindServiceType()" >
                                                            <option value="0">Please Select</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <select id="ddlservicetypemaster" class="form-control"  style="width:100%;"   >   <%--onchange="GetNextServiceDetails()"--%>
                                                            <option value="0">Please Select</option> 
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <table id="tblRecords" class="table table-bordered  table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        Last Renewal From / Ins. Due Date
                                    </th>
