<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="setMiscPermissions, App_Web_h5d101sg" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div class="col-md-12 well well-sm">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                             ...
                             <div class="col-md-4">
                                Select Permission:
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlPermission"
                                    SetFocusOnError="true" Display="Dynamic" InitialValue="0" ForeColor="Red" runat="server"
                                    ErrorMessage="*"></asp:RequiredFieldValidator>
                                <br />
                                <asp:DropDownList ID="ddlPermission" runat="server" CssClass="form-control" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlPermission_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                    <asp:ListItem Value="1">Show Account Summary  </asp:ListItem>
                                     <asp:ListItem Value="2"> Slip Particulars Delete Permission  </asp:ListItem>
     ...
     <asp:CheckBox ID="chkboxSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkboxSelectAll_CheckedChanged" ></asp:CheckBox> 
                                ...
                                <asp:TemplateField HeaderText="Item Name">
                                    <ItemTemplate>
                                     <asp:Label ID="lblpermissionid" Visible="false" runat="server" Text='<%# Bind("permissionid") %>'></asp:Label>
                                        <asp:Label ID="lblpermissionname" runat="server" Text='<%# Bind("permissionname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="View" Visible="false">
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkView" runat="server" />
                                         <asp:Label ID="lblviewpermission" Visible="false" runat="server" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" OnClick="DeletePermission"> <i class="glyphicon glyphicon-trash text-danger" style="font-size:large;"></i> </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div class="row">
                <div class="col-md-12" align="center">
                    <br />
                    <asp:Button ID="btnAssignMenu" runat="server" Text="Assign Permission to Selected User"
