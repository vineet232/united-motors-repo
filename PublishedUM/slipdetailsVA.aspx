<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="slipdetailsVA, App_Web_gdx0w2k3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/SlipMasterVA.js" type="text/javascript"></script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <input type="text" class="form-control" id="txtVehChasisNo" maxlength="50" placeholder="Veh./Chasis No"
                                            onkeypress="return /[0-9a-zA-Z]/i.test(event.key)"   />   <%-- ondrop="return false;" onpaste="return false;"--%>
                                    </div>
                                </div>
                                <div class="col-md-4">
