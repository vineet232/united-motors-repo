<%@ page title="" language="C#" masterpagefile="~/SuperAdminMasterPage.master" autoeventwireup="true" inherits="superadminuserpermissions, App_Web_xgwfkdro" %>
     ...
     <asp:CheckBox ID="chkboxSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkboxSelectAll_CheckedChanged" ></asp:CheckBox> 
            ...
            <div class="row">
                <div class="col-md-12" align="center">
                    <br />
                    <asp:Button ID="btnAssignMenu" runat="server" Text="Assign Selected Menu to Selected User"
