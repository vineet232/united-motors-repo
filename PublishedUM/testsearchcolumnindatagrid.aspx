<%@ page language="C#" autoeventwireup="true" inherits="testsearchcolumnindatagrid, App_Web_mdgle5ws" %>
            ...
            $.ajax({
                success: function (data) {
                    ...
                    { 'data': 'invoiceno' },
                        ...
                        bServerSide: true,
                        sAjaxSource: 'SaleTransactionDetailsCustomersHandlertest.ashx/GetSaleTransactionDetailsCustomersData?searchdt=' + searchDt,
                        sServerMethod: 'post'
                    });
