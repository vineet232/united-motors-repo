<%@ WebHandler Language="C#" Class="yardEntryHandler" %>
...
public class yardEntryHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        List<YardAnkurFunctions> listData = new List<YardAnkurFunctions>();
        int filteredCount = 0;
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataForYardAnkur", con);
            ...
            while (rdr.Read())
            {
                YardAnkurFunctions listItems = new YardAnkurFunctions();
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tblYardAnkur", con);
            con.Open();
