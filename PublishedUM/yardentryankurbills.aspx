<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="yardentryankurbills, App_Web_y0qsyvj2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
   <script src="DataTableActions/YardEntryAnkurBills.js" type="text/javascript"></script>
                                     ...
                                     <input type="hidden" name="hdnentrydt" id="hdnentrydt" value="">
                                      <input type="hidden" name="hdnmodelid" id="hdnmodelid" value="">
                                       <input type="hidden" name="hdnmodelname" id="hdnmodelname" value="">
                                        <input type="hidden" name="hdntotaldays" id="hdntotaldays" value="">
