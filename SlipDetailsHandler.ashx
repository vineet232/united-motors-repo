<%@ WebHandler Language="C#" Class="SlipDetailsHandler" %>
...
public class SlipDetailsHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        List<SlipDetailsFuncations> listData = new List<SlipDetailsFuncations>();
        int filteredCount = 0;
        ...
        {
            SqlCommand cmd = new SqlCommand("spGetDataSlipMaster", con);
            ...
            while (rdr.Read())
            {
                ...
                SlipDetailsFuncations listItems = new SlipDetailsFuncations();
    ...
    private int GetRecordsTotalCount()
    {
        ...
        {
            SqlCommand cmd = new
                SqlCommand("select count(*) from tblSlipmaster", con);
            con.Open();
