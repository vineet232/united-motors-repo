<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="TaxInvoiceUploadPriceList, App_Web_y0qsyvj2" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<script src="DataTableActions/TaxInvoicePriceListMaster2.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="row col-md-12">
                    <div class="col-md-4 topHeaderStyle" align="center">
                        Price List Test for Server Uploading
                    </div>
                    <div class="col-md-8" >
...
<div class="col-md-12 well well-sm" align="center" id="divUpload" runat="server" visible="false">
<div class="col-md-4">
<asp:FileUpload ID="FileUpload1" runat="server" />
</div>
<div class="col-md-4">
<asp:Button ID="btnUpload" Text="Upload" CssClass="btn btn-danger" OnClick="Upload" runat="server" />
</div>
<div class="col-md-4">
                                            ...
                                            <div class="row col-md-12">
                                               ...
                                               <%-- <div class="col-md-6" style="display:none;">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        <span class="input-group-addon"><i class="fa fa-edit fa-fw" aria-hidden="true"></i>
                                                         ...
                                                         <input type="text" class="form-control" id="txtProduct" maxlength="50" placeholder="Product"
                                               ...
                                               <%--  <div class="col-md-6">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtPurchasePrice" maxlength="20" placeholder="Purchase Price"  
                                                           onkeypress="return /[0-9.]/i.test(event.key)"  ondrop="return false;" onpaste="return false;" />
                                                    </div>
                                                </div>--%>
