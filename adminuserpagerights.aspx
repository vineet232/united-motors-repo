<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="adminuserpagerights, App_Web_y0qsyvj2" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
     ...
     <asp:CheckBox ID="chkboxSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkboxSelectAll_CheckedChanged" ></asp:CheckBox> 
                                ...
                                <asp:TemplateField HeaderText="Extra">
                                    <HeaderTemplate>
                                        <asp:CheckBox ID="chkboxSelectExtraAll" runat="server" Text="Extra" AutoPostBack="true"
                                            OnCheckedChanged="chkboxSelectExtraAll_CheckedChanged"></asp:CheckBox>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkExtra" runat="server" />
                                         <asp:Label ID="lblextrapermission" Visible="false" runat="server" Text='<%# Bind("extrapermission") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
