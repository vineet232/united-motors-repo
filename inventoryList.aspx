<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="inventoryList, App_Web_y0qsyvj2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/InventoryListMaster.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-md-12 well well-sm" align="center" >
        ...
        <div class="col-md-6" id="div1" runat="server" >
            ...
            Upload Back Order:
                <br />
                <asp:FileUpload ID="FileUploadBackOrder" runat="server" />
            </div>
            <div class="col-md-6">
                <asp:Button ID="btnUploadBackOrder" Text="Upload" CssClass="btn btn-danger" OnClick="Upload_Backorder"
                    runat="server" />
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="col-md-12 well well-sm" align="center" id="divUpload" runat="server"
        visible="false">
        <div class="col-md-4">
        Upload Inventory: <br />   <asp:FileUpload ID="FileUpload1" runat="server" />
        </div>
        <div class="col-md-4">
            <asp:Button ID="btnUploadInventory" Text="Upload" CssClass="btn btn-danger" OnClick="Upload_Inventory"
                runat="server" />
        </div>
        <div class="col-md-4">
                                ...
                                <div class="row col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group margin-bottom-sm">
                                            ...
                                            <input type="text" class="form-control" id="txtQty" maxlength="30" placeholder="Qty." readonly="readonly"
                                    ...
                                    <%--<div class="col-md-6">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtHsnCode" maxlength="20" placeholder="HSN Code"
                                               ...
                                               <div class="col-md-6">
                                                    <label for="modelname" class="labelclass">
                                                       CVBU Sale Price:</label>
                                                    <br />
                                                    <div class="input-group margin-bottom-sm">
                                                        <span class="input-group-addon"><i class="fa fa-rupee fa-fw" aria-hidden="true"></i>
                                                        </span>
                                                        <input type="text" class="form-control" id="txtCVBUSalePrice" maxlength="20" placeholder="CVBU Sale Price"  
                                                           onkeypress="return /[0-9.]/i.test(event.key)"  ondrop="return false;" onpaste="return false;" />
                                                    </div>
                                                </div>--%>
                                    <%--<div class="col-md-6">
                                    ...
                                    <%--<div class="col-md-6">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtLastIssueDt"   maxlength="10" placeholder="Last Issue Date" 
                                                          onkeydown="return false;"   ondrop="return false;" onpaste="return false;" />
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <label for="modelname" class="labelclass">
                                                        Last Received Date:</label>   
                                                         
                                                    <br />
                                                    <div class="input-group margin-bottom-sm">
                                                        <span class="input-group-addon"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i>
                                                        </span>
                                                        <input type="text" class="form-control" id="txtLastReceivedDt"   maxlength="10" placeholder="Last Received Date" 
                                                          onkeydown="return false;"   ondrop="return false;" onpaste="return false;" />
                                                    </div>
                                                </div>--%>
                                    <%-- <div class="col-md-6">
            ...
            <div>
                <div class="col-md-12" align="center" style="background-color: White !important;">
                    ...
                    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                      ...
                      <table id="tblRecords2" class="table table-bordered  table-responsive">
                        <thead>
                            <tr>
                                <th>
                                    Sr#
                    ...
                    <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                      ...
                      <table id="tblBackOrderDetails" class="table table-bordered  table-responsive">
                        <thead>
                            <tr>
                                <th>
                                    Sr#
