<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="masterBankVA, App_Web_h5d101sg" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/BankMasterVA.js" type="text/javascript"></script>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="txtName" maxlength="80" placeholder="Bank Name"  autocomplete="off" required
                                                          />
                                                 ...
                                                 <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="txtOpeningBalance" maxlength="20" autocomplete="off" placeholder="Opening Balance" 
                                                        onkeypress="return /[0-9 .-]/i.test(event.key)" onkeyup="myFunc(this);" ondrop="return false;" onpaste="return false;" required  />
                                                        </div>
                                                 ...
                                                 <div class="col-md-6">
                                                    ...
                                                    <%-- <input type="text" id="modelID" style="display:none;" />--%>
                                                     ...
                                                     <div class="input-group margin-bottom-sm">
                                                        <span class="input-group-addon"><i class="fa fa-rupee fa-fw" aria-hidden="true"></i></span>
                                                    <input type="text" class="form-control" id="txtCurrentBalance" autocomplete="off" maxlength="20" placeholder="Current Balance" 
                                                        onkeypress="return /[0-9 .-]/i.test(event.key)" onkeyup="myFunc(this);" ondrop="return false;" onpaste="return false;"  required />
                                                        </div>
