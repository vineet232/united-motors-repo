<%@ page title="" language="C#" masterpagefile="~/SuperAdminMasterPage.master" autoeventwireup="true" inherits="masterPaymentMethodwithBank, App_Web_y0qsyvj2" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/PaymentMethodMasterwithBank.js" type="text/javascript"></script>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div >
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="Payment Mode"  autocomplete="off" required
                                                 ...
                                                 <div class="col-md-3">
                                                    ...
                                                    <input type="checkbox" id="chkisbanktype" name="chkisbanktype" value="Active"  />
                                                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" id="txtpaymentcode" maxlength="50" placeholder="Payment Code"  autocomplete="off" required
                ...
                <div class="col-md-12" align="center" style="background-color: White !important; min-height:300px;">
                    <div class="c1">
