<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="masterdistricts, App_Web_h5d101sg" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <script src="DataTableActions/DistrictsMaster.js" type="text/javascript"></script>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="District Name" 
