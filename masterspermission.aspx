<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="masterspermission, App_Web_y0qsyvj2" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <div class="form-group">
                           <%-- <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                Select Master:
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlMaster"
                                    SetFocusOnError="true" Display="Dynamic" InitialValue="0" ForeColor="Red" runat="server"
                                    ErrorMessage="*"></asp:RequiredFieldValidator>
                                <br />
                                <asp:DropDownList ID="ddlMaster" runat="server" CssClass="form-control" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlMaster_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                    <asp:ListItem Value="1">Last Renewal From</asp:ListItem>
     ...
     <asp:CheckBox ID="chkboxSelectAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkboxSelectAll_CheckedChanged" ></asp:CheckBox> 
                                ...
                                <asp:TemplateField HeaderText="Item Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblItemName" runat="server" Text='<%# Bind("renewalfrom") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div class="row">
                <div class="col-md-12" align="center">
                    <br />
                    <asp:Button ID="btnAssignMenu" runat="server" Text="Assign Items to Selected User"
