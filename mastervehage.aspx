<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="mastervehage, App_Web_xgwfkdro" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="DataTableActions/VehicleAgeMaster.js" type="text/javascript"></script>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="Vehicle Age"
