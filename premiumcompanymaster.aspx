<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="premiumcompanymaster, App_Web_h5d101sg" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

<script src="DataTableActions/PremiumCompanyMaster.js" type="text/javascript"></script>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtName" maxlength="50" placeholder="Company Name"
                                                 ...
                                                 <div class="col-md-12">
                                                    ...
                                                    <div class="input-group margin-bottom-sm">
                                                        ...
                                                        <input type="text" class="form-control" id="txtparate" maxlength="50" placeholder="PA Rate"
                                                            onkeypress="return /[0-9a-zA-Z ]/i.test(event.key)"  /> <%--ondrop="return false;" onpaste="return false;"--%>
                                                    </div>
