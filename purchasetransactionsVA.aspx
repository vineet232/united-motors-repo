<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="purchasetransactionsVA, App_Web_1ssuryoo" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/PurchaseTransactionDetailsVA.js" type="text/javascript"></script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <input type="text" class="form-control" id="txtInvoiceSlipNo" maxlength="50" placeholder="Invoice/Slip No"
                                            autocomplete="off" />
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="col-md-4">
                                            ...
                                            <br />
                                           <select id="ddlTruckCompanies"  class="form-control" >
                                             <option value="0" selected="selected">Please Select</option>
                                             <option value="1" >Tata</option>
                                             <option value="2" >Mahindra & Mahindra</option>
                                             <option value="3" >Eicher Motors</option>
                                             <option value="4" >SML Isuzu</option>
                                             <option value="5" >Ashok Leyland</option>
                                             <option value="6" >Bharat Benz</option>
                                             <option value="7" >Force Motors</option>
                                           </select>
