<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="sparepartsdelivery, App_Web_1ssuryoo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/SparePartsDelivery.js" type="text/javascript"></script>
                            ...
                            <div class="form-group">
                                <div class="col-md-4" style="display:none;">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <input type="text" class="form-control" id="txtSlipNo" maxlength="50" placeholder="Challan No"
                                ...
                                <div class="col-md-4" style="display:none;">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <input type="text" class="form-control" id="txtPaymentMode" value="Credit" maxlength="40" placeholder="Payment Mode" />
                                    </div>
                                </div>
                                <div class="col-md-4" style="display:none;">
                                    <label for="modelname" class="labelclass">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <select id="ddlServiceType" class="form-control">
                                             <option value="0">Please Select</option>
                                            <option value="1">Body Shop</option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <select id="ddlStatus" runat="server" clientidmode="Static" class="form-control" onchange="ddlStatus_SelectedIndexChanged()">
                                            <%-- <option value="0">Please Select</option>--%>
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        ...
                                        <input type="text" class="form-control" id="txtgatepassno" maxlength="25" placeholder="Gate Pass No"
                                            onkeypress="return /[0-9a-zA-Z ]/i.test(event.key)" ondrop="return false;" onpaste="return false;" />
                                    </div>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="col-md-12" style="padding-top:6px;">
                                    <div class="col-md-1" style="visibility:hidden;">
                                     ...
                                     <div class="col-md-2" >
                                        <div class="col-md-8" nowarp>
                                            Tracker No#:
                                        </div>
                                        <div class="col-md-4">
                                           <div id="txtDTrackerNo" style="color: Red; font-weight: bold;">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                         ...
                                         <span class="input-group-addon"><i class="fa fa-user fa-fw" aria-hidden="true"></i>
                                                        ...
                                                        <select id="ddlIssuedTo" class="form-control" style="width:100%;">
                                                            <option value="0">Please Select</option>
                                                        </select>
