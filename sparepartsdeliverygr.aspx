<%@ page title="" language="C#" masterpagefile="~/AdminMasterPage.master" autoeventwireup="true" inherits="sparepartsdeliverygr, App_Web_h5d101sg" %>


<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"
    Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="DataTableActions/GRSparepartsoutwardsMaster.js" type="text/javascript"></script>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group margin-bottom-sm">
                                        <span class="input-group-addon"><i class="fa fa-truck fa-fw" aria-hidden="true"></i>
                                         ...
                                         <select id="ddlModel" class="form-control" style="width:100%;"  onchange="ddlModel_Change()">
